...
const FALLBACK_ROASTS = [
  ...
  "If laziness were an Olympic sport, you'd still come second.",
  "Your brain must be on airplane mode.",
  "You're not stupid, you just have bad luck thinking.",
  "I'd explain it to you, but I left my crayons at home.",
  "Your WiFi signal has more connection than your logic.",
  "You’re the human version of a typo.",
  "If confidence came with intelligence, you'd still be broke.",
  "You’re not useless… you could at least serve as a bad example.",
  "Your personality is like a software bug—annoying and hard to fix.",
  "If ignorance is bliss, you must be the happiest person alive.",
  "You have the energy of a phone at 1% battery.",
  "Your arguments crash harder than Internet Explorer.",
  "Even autocorrect can’t fix your sentences.",
  "You’re proof that evolution sometimes takes a coffee break.",
  "If thinking were a sport, you'd get disqualified for inactivity.",
  "You have the strategic thinking of a loading screen.",
  "I’ve seen smarter decisions from a coin toss.",
  "You're the reason the 'skip tutorial' button exists.",
  "You make mistakes look like achievements.",
  ...
  "You move slower than a Windows update.",
  "If talent were pixels, you'd be 144p.",
  "Your problem-solving skills are still buffering.",
  "Your confidence is impressive considering the evidence.",
  "You’re like a broken keyboard—completely pointless.",
  "Your ideas come with built-in errors.",
  "Even Google wouldn’t know what you’re trying to say.",
  "Your thoughts arrive later than dial-up internet.",
  "You’re the reason instructions say 'simple steps.'",
  "Even AI would return a 404 for your logic.",
  "You bring chaos where confusion already existed.",
  "If effort were measured, you'd barely register.",
  "Your brain runs on trial version software.",
  "Your decisions feel like beta testing gone wrong.",
  "If overconfidence were power, you'd light the whole city.",
  "You make bad ideas look organized.",
  "You're the loading screen of conversations.",
  "You’re not the sharpest tool in the shed—you’re the instruction manual.",
  "Even background characters have more impact.",
  "If intelligence were gravity, you'd float away.",
  "Your reasoning needs a system reboot.",
  "You argue like someone who skipped the manual.",
  "Your logic expired years ago.",
  "You’re the pop-up ad of human conversations.",
  "You make confusion look confident.",
  "If ideas were software, yours would be malware.",
  "Your explanations raise more questions than answers.",
  "Your brain runs slower than a free public WiFi.",
  "You talk like your thoughts are still downloading.",
  "If nonsense were art, you'd be a masterpiece.",
  "You’re the reason sarcasm was invented.",
  "Your arguments come with a built-in error message.",
  "You’re the plot twist nobody asked for.",
  "Even a broken clock sounds smarter twice a day.",
  "Your strategy feels like random button pressing.",
  "You think outside the box because you never understood the box.",
  "Your confidence deserves a better brain.",
  "You bring zero value but 100% noise.",
  "You’re like a phone without storage—nothing useful inside.",
  "Your thinking process took a wrong turn years ago.",
  "Even your shadow tries to avoid you.",
  "Your logic runs on low power mode permanently.",
  "You're a reminder that mistakes can walk.",
  "You confuse effort with noise.",
  "If brains were WiFi, you'd have no signal.",
  "You make simple things unnecessarily complicated.",
  "Even chaos has more structure than your ideas.",
  "Your thoughts need better internet.",
  "You're the bug developers forgot to patch.",
  "If confusion had a mascot, it would be you.",
  "Your decisions look like random number generators.",
  "Your confidence is doing all the heavy lifting.",
  "You make common sense look rare.",
  "If thinking had a loading bar, yours would never finish.",
  "Even NPCs have clearer dialogue.",
  "Your logic belongs in the recycle bin.",
  "You’re the side quest nobody wants.",
  "If ideas were code, yours wouldn’t compile.",
  "Your reasoning has too many syntax errors.",
  "You talk like your brain is lagging.",
  "Your arguments come pre-broken.",
  "You make confusion look professional.",
  "Your explanations need subtitles.",
  "If bad ideas had fans, you'd be famous.",
  "You bring zero clarity and maximum noise.",
  "Your thoughts need a firmware update.",
  "You’re the human equivalent of a warning message.",
  "Your logic has more bugs than a beta release.",
  "Even random guesses beat your predictions.",
  "You’re not mysterious—just consistently wrong.",
  "Your brain skipped the tutorial.",
  "If intelligence were a game, you'd still be in the loading screen.",
  "You make chaos look organized.",
  "Your thoughts feel like unfinished drafts.",
  "You bring confusion wherever clarity exists.",
  "You’re proof that overconfidence is free.",
  "Your brain must still be installing updates.",
];
